...
The need for a more over-arching, inclusive, multi-dimensional account of creativity has been widely recognised \cite{rhodes61,torrance67,plucker04defn,kaufman09}. Such an account would assist our understanding of creativity, highlighting areas of common ground and avoiding the pitfalls of disciplinary bias \cite{hennessey10,plucker04}.
...
The rest of this section considers the problem of providing a definition of creativity and reviews previous attempts to do so. The representation of subjective, ambiguous, loosely structured concepts is also considered.
...
\subsection*{RE-FRAME THIS? Background: {\em A question of definition}} \label{background}

...
The 30 papers selected for the creativity corpus are listed in Fig. 1a. %\ref{S1a_Fig}. 
\textbf{The search strategy used to select papers for this corpus is illustrated in a PRISMA \cite{prisma09} flow diagram, in Fig. 0a.} %\ref{S0a_Fig}. 

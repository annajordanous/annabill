...
\begin{flushleft}
{\Large
\textbf\newline{\bf Modelling creativity: identifying key components through a corpus-based approach}
\textbf\newline{\sout{Creativity is what we say it is: identifying key components of creativity}}
}
\newline
...
\sout{The rest of this section considers the problem of providing a definition of creativity and reviews previous attempts to do so.}
{\bf In the rest of this section we begin by noting a variety of attempts to define creativity.} The representation of subjective, ambiguous, loosely structured concepts is considered.
...
% Currently, no one definition has been adopted as standard, either in everyday use (as evidenced by the dictionary definitions considered below), for research % purposes \cite{rhodes61,taylor88,plucker04defn} or even in legal practice \cite{clifford04,mandel11}, where one would expect a term critical to legal 
% judgements  -- as creativity surely is \cite{feist91,karjala08,schafer15} -- to be precisely and unambiguously defined. 
%
...
%{\bf \em The next paragraph needs some thought, as it is is still talking about the need for definition. I think Plucker's comments on the original submission might suggest that he feels that this debate has now concluded (and that definition(s) of creativity have been provided. If so, then we need to modify this, at least.)}
...
\paragraph{\sout{Existing definitions.}{\bf Definitions of creativity.}}
\label{existing_defs}
...
\subsection*{\sout{Towards a clearer understanding of creativity}}\label{progressingForwards}

\sout{Returning to the concept under discussion } 
...
\sout{The proposed approach makes use of an empirical study and analysis of the language used to talk about creativity in order to gather and collate knowledge about the concept. In addition, following from the observations above, a   confluence approach to creativity is adopted [refs]
%\cite{sternberg99a,mayer99,ivcevic09}. 
This works on the principle that creativity results from several components converging and goes on to examine what these components are. Taking this approach in conjunction with the application of tools from computational linguistics and statistical analysis allows a wider disciplinary spectrum of perspectives on creativity to be captured than has previously been attempted. This is achieved by breaking down the whole into smaller and more tractable constituent parts identified through a broad cross-disciplinary examination of creativity research.}
...
The 30 papers selected for the creativity corpus are listed in Table \nameref{S1_Table}. 
\textbf{The search strategy used to select papers for this corpus is illustrated in a flow diagram, in Fig. \nameref{S1_Fig}. }
...
\textbf{Paper selection for the creativity corpus was governed by inclusion criteria based on measuring the influence of a paper and coverage of a wide range of years and academic disciplines. The inclusion criteria are as follows, listed in descending order of precedence: }
\begin{itemize}
...
The word frequency data derived from the two corpora was used to establish which words occur significantly more often in the creativity corpus than in the non-creativity corpus. This in turn can be regarded as providing evidence of which words are salient to the \sout{definition} \textbf{concept} of creativity. Salient words were identified using the log-likelihood ratio  (also referred to as the $G^2$ or G-squared statistic), which is a measure of how well observed data fit a model or expected distribution \cite{dunning93,kilgarriff01,rayson00,oakes98}. It provides an alternative to Pearson's chi-squared ($\chi^2$) test and has been advocated as the more appropriate measure of the two for corpus analysis as it does not rely on the (unjustifiable) assumption of normality in word distribution  \cite{dunning93,kilgarriff01,oakes98}. This is a particular issue when analysing smaller corpora, such as those used in the present work. 
...
From the analysis steps described in the previous section it was possible to extract a set of fourteen key components of creativity. These components are summarised in Fig. \nameref{S7_Fig} 
...
The resulting encoding can be visualised as a graph, as shown in Fig. \nameref{S8_Fig}. 
...
Rather than attempting to provide a unitary definition of creativity, our approach extracts common, underlying themes that transcend discipline or domain bias. Our point of departure is the observation that the vocabulary used in discussions of the nature of creativity may be analysed in order to throw light on our understanding of the concept and its key attributes. Using techniques from corpus linguistics and natural language processing (as described in the Methods section), key components of creativity have been identified. The results of this novel, empirical analysis (presented in the Results section) inform the development of an {\em ontology of creativity\/} comprising a set of fourteen distinct components (see Fig. \nameref{S7_Fig}).
...
%\begin{figure}
%\caption{ A flow diagram describing the search strategy used to identify papers for the creativity corpus}
% REMOVE IMAGES FROM SUBMITTED VERSION
%\includegraphics[width=\textwidth]{images/PRISMAcc}
%\label{S1_Fig}
%\end{figure} 
...
% REMOVE IMAGES FROM SUBMITTED VERSION
%\includegraphics[width=\textwidth]{images/PRISMAncc}
%\label{S2_Fig}
%\end{figure} 
...
%\begin{figure}[!ht]
% \begin{center}
%\includegraphics[scale=0.5]{images/disciplines}
% \end{center}
% \caption{Representation of the disciplinary breakdown of the Creativity Corpus by time period. Disciplines are as specified for the paper's journal, by the academic database {\em Scopus}. Note that Scopus may classify a journal under more than one discipline.}
% \label{S3_Fig}
%\end{figure}  


\subsection*{S4 Fig}\label{S4_Fig}
...
%\begin{figure}
%\caption{Word pairwise similarity data visualised as an edge-weighted graph, where nodes  correspond to words and edges are weighted by similarity scores (for any score $>$ 0). }
% REMOVE IMAGES FROM SUBMITTED VERSION
%\includegraphics[width=\textwidth]{images/conceptIdea}
%\label{S4_Fig}
%\end{figure} 
...
% TABLES
%%%%%%
\subsection*{S1 Table}\label{S1_Table}
...
Paper \\
\hline
T. M. Amabile. The social psychology of creativity: A componential conceptualization. \\ 	
	\hspace{10mm} Journal of Personality and Social Psychology, 45(2):357-376, 1983. \\
M. A. Boden. Precis of The Creative Mind: Myths and mechanisms.  \\ 	
	\hspace{10mm} Behavioural and Brain Sciences, 17(3):519-570, 1994. \\
D. T. Campbell. Blind variation and selective retentions in creative thought as in other knowledge processes.  \\ 	
	\hspace{10mm} Psychological Review, 67(7):380-400, 1960. \\
S. Colton, A. Pease \& G. Ritchie. The effect of input knowledge on creativity.  \\ 	
	\hspace{10mm} In Proceedings of Workshop Program of ICCBR-Creative Systems, 2001. \\
M. Csikszentmihalyi. Motivation and creativity: Toward a synthesis of structural and energistic approaches to cognition.  \\ 	
	\hspace{10mm} New Ideas in Psychology, 6(2):159-176, 1988. \\
M. Dellas \&  E. L. Gaier. Identification of creativity: The individual.  \\ 	
	\hspace{10mm} Psychological Bulletin, 73(1):55- 73, 1970. \\
A. Dietrich. The cognitive neuroscience of creativity.  \\ 	
	\hspace{10mm} Psychonomic Bulletin \& Review, 11(6):1011-1026, 2004. \\
G. Domino. Identification of potentially creative persons from the adjective check list.  \\ 	
	\hspace{10mm} Journal of Consulting and Clinical Psychology, 35(1):48-51, 1970. \\
W. Duch. Intuition, insight, imagination and creativity.  \\ 	
	\hspace{10mm} IEEE Computational Intelligence Magazine, 2(3):40-52, 2007. \\
C. S. Findlay \&  C. J. Lumsden. The creative mind: Toward an evolutionary theory of discovery and innovation.  \\ 	
	\hspace{10mm} Journal of Social and Biological Systems, 11(1):3-55, 1988. \\
C. M. Ford. A theory of individual creative action in multiple social domains.  \\ 	
	\hspace{10mm} The Academy of Management Review, 21(4):1112-1142, 1996. \\
J. Gero. Creativity, emergence and evolution in design.  \\ 	
	\hspace{10mm} Knowledge-Based Systems, 9(7):435-448, 1996.  \\
H. G. Gough. A creative personality scale for the adjective checklist.  \\ 	
	\hspace{10mm} Journal of Personality and Social Psychology, 37(8):1398-1405, 1979. \\
J. P. Guilford. Creativity.  \\ 	
	\hspace{10mm} American Psychologist, 5:444-454, 1950. \\
Z. Ivcevic. Creativity map: Toward the next generation of theories of creativity.  \\ 	
	\hspace{10mm} Psychology of Aesthetics, Creativity, and the Arts, 3(1):17-21, 2009. \\
K. H. Kim. Can we trust creativity tests? A review of the Torrance tests of creative thinking (TTCT).  \\ 	
	\hspace{10mm} Creativity Research Journal, 18(1):3-14, 2006. \\
L. A. King, L. McKee Walker \&  S. J. Broyles. Creativity and the five-factor model.  \\ 	
	\hspace{10mm} Journal of Research in Personality, 30(2):189-203, 1996. \\
R. R. McCrae. Creativity, divergent thinking, and openness to experience.  \\ 	
	\hspace{10mm} Journal of Personality and Social Psychology, 52(6):1258-1265, 1987. \\
S. A. Mednick. The associative basis of the creative process.  \\ 	
	\hspace{10mm} Psychological Review, 69(3):220-232, 1962.  \\
M. D. Mumford \&  S. B. Gustafson. Creativity syndrome: Integration, application, and innovation.  \\ 	
	\hspace{10mm} Psychological Bulletin, 103(1):27-43, 1988.  \\
M. T. Pearce, D. Meredith \&  G. A. Wiggins. Motivations and methodologies for automation of the compositional process.  \\ 	
	\hspace{10mm} Musicae Scientae, 6(2):119-147, 2002. \\
J. A. Plucker, R. A. Beghetto \&  G. T. Dow. Why isn't creativity more important to educational psychologists? \\ 	
	\hspace{10mm}  Potentials, pitfalls, and future directions in creativity research. \\ 	
	\hspace{10mm}  Educational Psychologist, 39(2):83-96, 2004. \\
R. Richards, D. K. Kinney, M. Benet \& A. P. C. Merzel. Assessing everyday creativity: \\ 	
	\hspace{10mm}  Characteristics of the lifetime creativity scales and validation with three large samples.  \\ 	
	\hspace{10mm} Journal of Personality and Social Psychology, 54(3):476-485, 1988. \\
G. Ritchie. The transformational creativity hypothesis.  \\ 	
	\hspace{10mm} New Generation Computing, 24(3):241-266, 2006. \\
G. Ritchie. Some empirical criteria for attributing creativity to a computer program.  \\ 	
	\hspace{10mm} Minds and Machines, 17:67-99, 2007. \\
D. L. Rubenson \&  M. A. Runco. The psychoeconomic approach to creativity.  \\ 	
	\hspace{10mm} New Ideas in Psychology, 10(2):131-147, 1992. \\
M. A. Runco \&  I. Chand. Cognition and creativity.  \\ 	
	\hspace{10mm} Educational Psychology Review, 7(3):243-267, 1995. \\
D. K. Simonton. Creativity: Cognitive, personal, developmental, and social aspects.  \\ 	
	\hspace{10mm} American Psychologist, 55(1):151-158, 2000. \\
J. R. Suler. Primary process thinking and creativity.  \\ 	
	\hspace{10mm} Psychological Bulletin, 88(1):144-165, 1980. \\
G. A. Wiggins. A preliminary framework for description, analysis and comparison of creative systems. \\ 	
	\hspace{10mm}  Knowledge-Based Systems, 19(7):449-458, 2006.
\end{tabular}
\end{center}
\normalsize
...
\subsection*{S2 Table}\label{S2_Table}
{\bf The 60 papers that make up the Non-Creativity Corpus} 
\begin{table}[!h]%dp]
\begin{adjustwidth}{-2.25in}{0in} % Comment out/remove adjustwidth environment if table fits in text column.
\footnotesize
\begin{center}
...
Paper \\
\hline 
C. Ames \& J. Archer. Achievement goals in the classroom: Students' learning strategies and motivation processes. \\ 	
	\hspace{10mm} Journal of Educational Psychology, 80(3):260-267, 1988. \\ % Cited by:  (since 1996) 639. \\
J. Anderson \& D. Gerbing. Structural equation modeling in practice: A review and recommended two-step approach. \\ 	
	\hspace{10mm} Psychological Bulletin, 103(3):411-423, 1988. \\ % Cited by:  (since 1996) 3884. \\
J. Arnett. Emerging adulthood: A theory of development from the late teens through the twenties. \\ 	
	\hspace{10mm} American Psychologist, 55(5):469-480, 2000. \\ % Cited by:  (since 1996) 800. \\
M. Arulampalam, S. Maskell, N. Gordon \& T. Clapp. A tutorial on particle filters for online nonlinear/non-gaussian bayesian tracking. \\ 	
	\hspace{10mm} IEEE Transactions on Signal Processing, 50(2):174-188, 2002. \\ % Cited by:  (since 1996) 1984. \\
A. Baddeley. Exploring the central executive. \\ 	
	\hspace{10mm} Quarterly Journal of Experimental Psychology Section A: Human Experimental Psychology, 49(1):5-28, 1996. \\ % Cited by:  (since 1996) 672. \\
T. Baker, M. Piper, D. McCarthy, M. Majeskie \& M. Fiore. Addiction motivation reformulated: An affective processing model of negative reinforcement. \\ 	
	\hspace{10mm} Psychological Review, 111(1):33-51, 2004. \\ % Cited by:  (since 1996) 177. \\
P. Barnett \& I. Gotlib. Psychosocial functioning and depression: Distinguishing among antecedents, concomitants \& consequences. \\ 	
	\hspace{10mm} Psychological Bulletin, 104(1):97-126, 1988. \\ % Cited by:  (since 1996) 366. \\
J. Baron. Nonconsequentialist decisions. \\ 	
	\hspace{10mm} Behavioral \& Brain Sciences, 17(1):1-42, 1994. \\ % Cited by:  (since 1996) 68. \\
F. Beach. The snark was a boojum. \\ 	
	\hspace{10mm} American Psychologist, 5(4):115-124, 1950. \\ % Cited by:  (since 1996) 32. \\
M. Belkin, P. Niyogi \& V. Sindhwani. \\ 	
	\hspace{10mm} Manifold regularization: A geometric framework for learning from labeled and unlabeled examples. Journal of Machine Learning Research, 7:2399-2434, 2006. \\ % Cited by:  (since 1996) 145. \\
G. Bonanno. Loss, trauma \& human resilience: Have we underestimated the human capacity to thrive after extremely aversive events? \\ 
	\hspace{10mm} American Psychologist, 59(1):20-28, 2004. \\ % Cited by:  (since 1996) 352. \\
T. Chan \& L. Vese. Active contours without edges. \\ 	
	\hspace{10mm} IEEE Transactions on Image Processing, 10(2):266-277, 2001. \\ % Cited by:  (since 1996) 1520. \\
H. Cheng \& J. Schweitzer. Cultural values reflected in Chinese and U.S. television commercials. \\ 	
	\hspace{10mm} Journal of Advertising Research, 36(3):27-45, 1996. \\ % Cited by:  (since 1996) 88. \\
C. Coello Coello. Evolutionary multi-objective optimization: A historical view of the field. \\ 	
	\hspace{10mm} IEEE Computational Intelligence Magazine, 1(1):28-36, 2006. \\ % Cited by:  (since 1996) 109. \\
D. Comaniciu \& P. Meer. Mean shift: A robust approach toward feature space analysis. \\ 	
	\hspace{10mm} IEEE Transactions on Pattern Analysis \& Machine Intelligence, 24(5):603-619, 2002.  \\ % Cited by:  (since 1996) 1613 \\
L. Cronbach \& L. Furby. How we should measure `change': Or should we? \\ 	
	\hspace{10mm} Psychological Bulletin, 74(1):68-80, 1970. \\ % Cited by: (since 1996) 526. \\
M. Davis. Measuring individual differences in empathy: Evidence for a multidimensional approach. \\ 	
	\hspace{10mm} Journal of Personality \& Social Psychology, 44(1):113-126, 1983. \\ % Cited by:  (since 1996) 631. \\
J. Dem\~{s}ar. Statistical comparisons of classifiers over multiple data sets. \\ 	
	\hspace{10mm} Journal of Machine Learning Research, 7:1-30, 2006. \\ % Cited by:  (since 1996) 389. \\
M. Dorigo, M. Birattari \& T. St\"{u}tzle. Ant colony optimization artificial ants as a computational intelligence technique. \\ 	
	\hspace{10mm} IEEE Computational Intelligence Magazine, 1(4):28-39, 2006. \\ % Cited by:  (since 1996) 134. \\
E. Fischer \& J. Turner. Orientations to seeking professional help: Development and research utility of an attitude scale. \\ 	
	\hspace{10mm} Journal of Consulting \& Clinical Psychology, 35(1 PART 1):79-90, 1970. \\ % Cited by:  (since 1996) 189. \\
J. Gibson. Observations on active touch. \\ 	
	\hspace{10mm} Psychological Review, 69(6):477-491, 1962. \\ % Cited by:  (since 1996) 179. \\
A. Gopnik \& J. Astington. Children's understanding of representational change and its relation to the understanding of false belief and the appearance-reality distinction. \\ 	
	\hspace{10mm} Child development, 59(1):26-37, 1988. \\ % Cited by:  (since 1996) 314. \\
S. Gosling, S. Vazire, S. Srivastava \& O. John. Should we trust web-based studies? A comparative analysis of six preconceptions about internet questionnaires. \\ 	
	\hspace{10mm} American Psychologist, 59(2):93-104, 2004. \\ % Cited by:  (since 1996) 313. \\
J. Gray. The psychophysiological basis of introversion-extraversion. \\ 	
	\hspace{10mm} Behaviour Research \& Therapy, 8(3):249-266, 1970. \\ % Cited by:  (since 1996) 225. \\
B. Grosz \& S. Kraus. Collaborative plans for complex group action. \\ 	
	\hspace{10mm} Artificial Intelligence, 86(2):269- 357, 1996. \\ % Cited by:  (since 1996) 275. \\
P. Groves \& R. Thompson. Habituation: A dual-process theory. \\ 	
	\hspace{10mm} Psychological Review, 77(5):419-450, 1970. \\ % Cited by:  (since 1996) 375. \\
M. Hall, J. Anderson, S. Amarasinghe, B. Murphy, S.-W. Liao, E. Bugnion \& M. Lam. Maximizing multiprocessor performance with the SUIF compiler. \\ 	
	\hspace{10mm} Computer, 29(12):84-89, 1996. \\ % Cited by:  (since 1996) 161. \\
F. Happ\'{e}. The role of age and verbal ability in the theory of mind task performance of subjects with autism. Child development, 66(3):843-855, 1995. \\ % Cited by:  (since 1996) 285. \\
C. Harland. Supply chain management: Relationships, chains and networks. \\ 	
	\hspace{10mm} British Journal of Management, 7(SPEC. ISS.):S63-S80, 1996. \\ % Cited by:  (since 1996) 172. \\
S. Hayes, K. Strosahl, K. Wilson, R. Bissett, J. Pistorello, D. Toarmino, M. Polusny, T. Dykstra, S. Batten, J. Bergan, S. Stewart, M. Zvolensky, G. Eifert, F. Bond, J. Forsyth, M. Karekla \& S. McCurry. Measuring experiential avoidance: A preliminary test of a working model. \\ 	
	\hspace{10mm} Psychological Record, 54(4):553-578, 2004. \\ % Cited by:  (since 1996) 168. \\
J. Hirsch \& K. L\"{u}cke. Overview no. 76. mechanism of deformation and development of rolling textures in polycrystalline f.c.c. metals-i. description of rolling texture development in homogeneous cuzn alloys. \\ 	
	\hspace{10mm} Acta Metallurgica, 36(11):2863-2882, 1988. \\ % Cited by:  (since 1996) 243. \\
P. Killeen. Mathematical principles of reinforcement. \\ 	
	\hspace{10mm} Behavioral \& Brain Sciences, 17(1):105-172, 1994. \\ % Cited by:  (since 1996) 86. \\
P. Kirschner, J. Sweller \& R. Clark. Why minimal guidance during instruction does not work: An analysis of the failure of constructivist, discovery, problem-based, experiential \& inquiry-based teaching. \\ 	
	\hspace{10mm} Educational Psychologist, 41(2):75-86, 2006. \\ % Cited by:  (since 1996) 139. \\
S. Liao. Notes on the homotopy analysis method: Some definitions and theorems. \\ 	
	\hspace{10mm} Communications in Nonlinear Science \& Numerical Simulation, 14(4):983-997, 2009. \\ % Cited by:  (since 1996) 56. \\
C. Lord, L. Ross \& M. Lepper. Biased assimilation and attitude polarization: The effects of prior theories on subsequently considered evidence. \\ 	
	\hspace{10mm} Journal of Personality \& Social Psychology, 37(11):2098- 2109, 1979. \\ % Cited by:  (since 1996) 523. \\
S. Luthar, D. Cicchetti \& B. Becker. The construct of resilience: A critical evaluation and guidelines for future work. \\ 	
	\hspace{10mm} Child Development, 71(3):543-562, 2000. \\ % Cited by:  (since 1996) 566. \\
G. Mandler. Recognizing: The judgment of previous occurrence. \\ 	
	\hspace{10mm} Psychological Review, 87(3):252-271, 1980. \\ % Cited by:  (since 1996) 877. \\
G. Miller \& J. Selfridge. Verbal context and the recall of meaningful material. \\ 	
	\hspace{10mm} The American journal of psychology, 63(2):176-185, 1950. \\ % Cited by:  (since 1996) 57. \\
S. Miller. Monitoring and blunting: Validation of a questionnaire to assess styles of information seeking under threat. \\ 	
	\hspace{10mm} Journal of Personality \& Social Psychology, 52(2):345-353, 1987. \\ % Cited by:  (since 1996) 385. \\
G. Navarro \& V. M\"{a}kinen. Compressed full-text indexes. \\ 	
	\hspace{10mm} ACM Computing Surveys, 39(1), 2007. \\ % Cited by:  (since 1996) 62. \\
M. Nissen \& P. Bullemer. Attentional requirements of learning: Evidence from performance measures. \\ 	
	\hspace{10mm} Cognitive Psychology, 19(1):1-32, 1987. \\ % Cited by:  (since 1996) 729. \\
J. Payne, J. Bettman \& E. Johnson. Adaptive strategy selection in decision making. \\ 	
	\hspace{10mm} Journal of Experimental Psychology: Learning, Memory \& Cognition, 14(3):534-552, 1988. \\ % Cited by:  (since 1996) 300. \\
J. Prochaska, C. DiClemente \& J. Norcross. In search of how people change: Applications to addictive behaviors. \\ 	
	\hspace{10mm} American Psychologist, 47(9):1102-1114, 1992. \\ % Cited by:  (since 1996) 2742. \\
T. Richardson, M. Shokrollahi \& R. Urbanke. Design of capacity-approaching irregular low-density parity-check codes. \\ 	
	\hspace{10mm} IEEE Transactions on Information Theory, 47(2):619-637, 2001. \\ % Cited by:  (since 1996) 1162. \\
W. Rozeboom. The fallacy of the null-hypothesis significance test. \\ 	
	\hspace{10mm} Psychological Bulletin, 57(5):416-428, 1960. \\ % Cited by:  (since 1996) 133. \\
C. Rusbult. A longitudinal test of the investment model: The development (and deterioration) of satisfaction and commitment in heterosexual involvements. \\ 	
	\hspace{10mm} Journal of Personality \& Social Psychology, 45(1):101-117, 1983. \\ % Cited by:  (since 1996) 301. \\
T. Ryan. Significance tests for multiple comparison of proportion, variance, and other statistics. \\ 	
	\hspace{10mm} Psychological Bulletin, 57(4):318-328, 1960. \\ % Cited by:  (since 1996) 154. \\
W. Schultz. Behavioral theories and the neurophysiology of reward. \\ 	
	\hspace{10mm} Annual Review of Psychology, 57:87-115, 2006. \\ % Cited by:  (since 1996) 226. \\
E. Sirin, B. Parsia, B. Grau, A. Kalyanpur \& Y. Katz. Pellet: A practical OWL-DL reasoner. \\ 	
	\hspace{10mm} Web Semantics, 5(2):51-53, 2007. \\ % Cited by:  (since 1996) 125. \\
T. Srull \& R. Wyer. The role of category accessibility in the interpretation of information about persons: Some determinants and implications. \\ 	
	\hspace{10mm} Journal of Personality \& Social Psychology, 37(10):1660- 1672, 1979. \\ % Cited by:  (since 1996) 374. \\
J. Steiger. Tests for comparing elements of a correlation matrix. \\ 	
	\hspace{10mm} Psychological Bulletin, 87(2):245-251, 1980. \\ % Cited by:  (since 1996) 705. \\
L. Steinberg, S. Lamborn, S. Dornbusch \& N. Darling. Impact of parenting practices on adolescent achievement: authoritative parenting, school involvement, and encouragement to succeed. \\ 	
	\hspace{10mm} Child development, 63(5):1266-1281, 1992. \\ % Cited by:  (since 1996) 435. \\
D. Tao, X. Li, X. Wu, W. Hu \& S. Maybank. Supervised tensor learning. \\ 	
	\hspace{10mm} Knowledge \& Information Systems, 13(1):1-42, 2007. \\ % Cited by:  (since 1996) 54. \\
A. Tellegen, D. Lykken, T. Bouchard Jr., K. Wilcox, N. Segal \& S. Rich. Personality similarity in twins reared apart and together. \\ 	
	\hspace{10mm} Journal of Personality \& Social Psychology, 54(6):1031-1039, 1988. \\ % Cited by:  (since 1996) 398. \\
L. Thomas \& D. Ganster. Impact of family-supportive work variables on work-family conflict and strain: A control perspective. \\ 	
	\hspace{10mm} Journal of Applied Psychology, 80(1):6-15, 1995. \\ % Cited by:  (since 1996) 339. \\
I. Thompson. Coupled reaction channels calculations in nuclear physics. \\ 	
	\hspace{10mm} Computer Physics Reports, 7(4):167-212, 1988. \\ % Cited by:  (since 1996) 360. \\
E. Tulving. Subjective organization in free recall of ``unrelated'' words. \\ 	
	\hspace{10mm} Psychological Review, 69(4):344- 354, 1962. \\ % Cited by:  (since 1996) 121. \\
U. Von Luxburg. A tutorial on spectral clustering. \\ 	
	\hspace{10mm} Statistics \& Computing, 17(4):395-416, 2007. \\ % Cited by:  (since 1996) 107. \\
J. Williams, A. Mathews \& C. MacLeod. The emotional Stroop task and psychopathology. \\ 	
	\hspace{10mm} Psychological Bulletin, 122(1):3-24, 1996. \\ % Cited by:  (since 1996) 716. \\
J. Wright, A. Yang, A. Ganesh, S. Sastry \& Y. Ma. Robust face recognition via sparse representation. \\ 	
	\hspace{10mm} IEEE Transactions on Pattern Analysis \& Machine Intelligence, 31(2):210-227, 2009. \\ % Cited by:  (since 1996) 46.
\end{tabular}
\end{center}
\normalsize
\caption{The 60 papers that make up the Non-Creativity Corpus}
\end{adjustwidth}
\end{table}%

\subsection*{S3 Table}\label{S3_Table}
{\bf The top 20 results (in descending order) of the log-likelihood ratio (LLR) calculations. A significant LLR score at p=0.001 is 10.83. N.B. POS=Part Of Speech: N=noun, J=adjective, V=verb, R=adverb.} 
\begin{table}[!h]%dp]
\begin{center}
...
\end{tabular}
\end{center}
\caption{The top 20 results (in descending order) of the log-likelihood ratio (LLR) calculations. A significant LLR score at p=0.001 is 10.83. N.B. POS=Part Of Speech: N=noun, J=adjective, V=verb, R=adverb.}
\end{table}%

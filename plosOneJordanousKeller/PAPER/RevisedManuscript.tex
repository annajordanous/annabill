...
\begin{itemize}
\item[] {\em \textbf{Creativity corpus}: a collection of thirty academic papers which explicitly discuss the nature of creativity.\\}
\end{itemize}
%\vspace{0.25cm}
%\begin{center}
%\fbox{
...
%\begin{minipage}{0.8\linewidth}
\begin{itemize}
\item[] {\em \textbf{Non-creativity corpus}:  a collection of sixty academic papers on topics unrelated to creativity, from the  same range of academic disciplines and publication years as  the creativity corpus papers.}
\end{itemize}
%\end{minipage}
%}
%\end{center}
